...
>(({ className, children, placeholder, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-md border-b border-neutral-200 bg-transparent px-3 py-2 text-[1.1rem] ring-offset-white focus:outline-none focus:ring-2 focus:ring-neutral-950 focus:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 dark:border-neutral-800 dark:bg-neutral-950 dark:ring-offset-neutral-950 dark:focus:ring-neutral-300",
      className
    )}
    {...props}
  >
    <SelectValue
      ...
      className="data-[placeholder]:text-neutral-300 text-white data-[placeholder]:opacity-80"
    />
